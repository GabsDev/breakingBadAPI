- list of any requirements you could not implement: Episodes Page
- Bugs you’ve identified but didn’t have time to fix: Navigation routing
- Things you would do if you had more time to complete the task: Create Episodes Page and Fix Navigation
